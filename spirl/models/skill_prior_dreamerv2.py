...
class SkillPriorDreamer(BaseModel, ProbabilisticModel):
    ...
    def _build_inference_net(self):
        ...
        ## Here we want to modify this so that we take the output of the dense (linear) layer
        ## and sample a one-hot vector from the softmax of the output vector of logits
